...
| [azure-deployment-design.md](azure-deployment-design.md) | Azure 개발 서버 배포 및 CI/CD 운영 | 실제 서버 상태, GitHub Actions 자동 배포 활성 여부·동작·복구 절차를 기록 | Azure 배포 상태·CI/CD·복구를 구현, 검토, 운영할 때 |
